...
class Filter extends Component {
  ...
  bind() {
    this._element.querySelector(`input[name="filter"]`).addEventListener(`change`, this._onChange);
  }

  unbind() {
    this._element.querySelector(`input[name="filter"]`).removeEventListener(`change`, this._onChange);
  }
}
